...
import Modal from "c@/omponents/modal";
...
const WebhookModal = ({ open, onRequestClose }) => (
  ...
  >
    ...
    <p>
      Webhooks are data sent on demand from one app (AHW) to another over
      ...
      {JSON.stringify(
        {
          ...
          subscription_url: "url to my HW for managing the area",
